...
import 'package:authentication_and_authorization_frontend/src/app/utils/rest_client/dio_rest_client.dart';
import 'package:authentication_and_authorization_frontend/src/app/utils/local_storage/hive_local_storage.dart';
import 'package:authentication_and_authorization_frontend/src/app/utils/local_storage/secure_local_storage.dart';
...
class AppModule extends Module {
  ...
  List<Bind> get binds => [
        ...
        Bind.factory<ILocalStorage>((i) => HiveLocalStorage(i()), export: true),
